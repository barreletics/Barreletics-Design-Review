...
| Sock math | Compact (`pdp-sock-math` · headline “One pair. Done.” · **no review quote** · CTA empty) — quote removed 2026-08-09 (Andrew: version without review). **COPY LOCKED 2026-08-15 mock L:** `docs/pdp-sock-math-directions.html` **L** — One pair. Done. / 3-pack / This ends that. / Cycle: Silicone never grips. Fabric stretches. Dots fall off in the wash. / Pair: 360° grip · Secure in every hold. / Foot: Yoga socks are useless. **Photo queue 2026-08-15 (contain, no crop):** Closed = L white 1000 · Open = N yellow court · Shop All = Q outdoor class · Spare = M blue studio. **B Multi_Image skipped** (already on commit 50/50). White Shopify master is 1000×1000 — no larger file. Editorial `object-fit: contain` in `pdp-sock-math.liquid`. Not on M4 until theme named. |
