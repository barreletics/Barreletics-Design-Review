...
| Sock math | Compact (`pdp-sock-math` · headline “One pair. Done.” · **no review quote** · CTA empty) — quote removed 2026-08-09 (Andrew: version without review). **COPY LOCKED 2026-08-15 mock L:** `docs/pdp-sock-math-directions.html` **L** — One pair. Done. / 3-pack / This ends that. / Cycle: Silicone never grips. Fabric stretches. Dots fall off in the wash. / Pair: 360° grip · Secure in every hold. / Foot: Yoga socks are useless. **Photo queue 2026-08-15 (fill the box):** 1 Blue court IMG_5051 · 2 M studio P5A7000 · 3 Q outdoor class. Not “yellow court.” Lifestyle = cover, 680px well. Not on M4 until theme named. |
