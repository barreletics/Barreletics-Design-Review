...
|---------|--------------|---------------|-----------------|--------------|-----------------|
| **Shop All (grippy shoes)** | `/collections/barre-pilates-yoga-shoe-sock-footwear` | `collection.json` | Hub mock still **Collection v18 Locked** → `docs/Barreletics Collection - Definitive-v18.html` (do not overwrite). **M4 APPROVED 2026-09-03:** Hero + patented lede → value strip (Made in USA · Free exchanges · 30-day returns · 90-day warranty) → Studio → grid 2 rows → Real people. Upgrade off. — `templates/collection.json` | *(default / none)* | `/collections/barre-pilates-yoga-shoe-sock-footwear` |
