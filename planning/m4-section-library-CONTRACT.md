...
**Forbidden without explicit Andrew approval in the CURRENT message:** git checkout of frozen section files from old commits; Impulse/live/dark Phase 1 swaps; gallery “picks” as deployable replacements; inventing alternate footers/heroes/PDP spines.
